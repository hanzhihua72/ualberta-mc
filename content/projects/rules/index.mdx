...
-   Extreme hacks that break gameplay and lag the server will result in a 5 second ban. The reason the ban length is so low is because sometimes the anticheat will falsely kick innocent players. If there is sufficient demand, I will increase the ban length.

#### Clans

Clans is supported by this server, which allows players to not take damage from teammates and access to a private chat.
